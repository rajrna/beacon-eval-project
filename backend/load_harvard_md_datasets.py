"""
Load Harvard Medical School datasets into the database.
Run AFTER creating Harvard University and MD program through the frontend.

Usage:
  python load_harvard_md_datasets.py --program-id <your-program-uuid>

Or set HARVARD_MD_PROGRAM_ID environment variable.
"""
import asyncio
import json
import sys
...
DATASET_CONFIGS = [
    ("MD Admissions Q&A", "admissions", "harvard_md_admissions.jsonl"),
    ("MD Financial Aid", "finaid", "harvard_md_finaid.jsonl"),
    ("MD Retention & Support", "retention", "harvard_md_retention.jsonl"),
    ("MD Adversarial Examples", "safety", "harvard_md_adversarial.jsonl"),
    ("MD Clinical Safety", "safety", "harvard_md_clinical_safety.jsonl"),
]
...
async def load(program_id: str) -> None:
    ...
    print("\n✅ Harvard MD datasets loaded successfully.")
...
if __name__ == "__main__":
    ...
    if not program_id:
        print("Usage: python load_harvard_md_datasets.py --program-id <uuid>")
        print("   or: set HARVARD_MD_PROGRAM_ID=<uuid> and run python load_harvard_md_datasets.py")
        print()
        print("Get your program ID from the frontend:")
